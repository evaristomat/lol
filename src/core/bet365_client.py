...
from .exceptions import BetsAPIError, RateLimitError
...
class Bet365Client:
    ...
    async def inplay(self) -> Dict[str, Any]:
        return await self._make_request("v1/bet365/inplay")
    ...
    async def inplay_filter(
        ...
        return await self._make_request("v1/bet365/inplay_filter", params)
    ...
    async def event(
        ...
        if raw:
            params["raw"] = 1
        return await self._make_request("v1/bet365/event", params)
    ...
    async def upcoming(
        ...
        if page:
            params["page"] = page
        return await self._make_request("v1/bet365/upcoming", params)
    ...
    async def prematch(self, FI: str, raw: bool = False) -> Dict[str, Any]:
        ...
        if raw:
            params["raw"] = 1
        return await self._make_request("v3/bet365/prematch", params)
    ...
    async def result(self, event_id: str, raw: bool = False) -> Dict[str, Any]:
        ...
        if raw:
            params["raw"] = 1
        return await self._make_request("v1/bet365/result", params)
